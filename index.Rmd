...
top60 <- rownames(Expression)[rowMeans(Expression) > quantile(rowMeans(Expression),0.4)]
DEResults2 <- DEResults[DEResults$ID %in% top60,]
...
* Question 5 - Make a boxplot plot of the log10 of region sizes for each chromosome as shown below using ggplot graphics.
...
library(ggplot2)
  ...
  scale_y_log10()+
  theme_minimal()+
  xlab("region sizes (log10)")+ggtitle("Boxplot of region sizes")+coord_flip()
